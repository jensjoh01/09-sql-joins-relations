...
const app = express();
const conString = 'postgres://localhost:5432';// DONE/DONE: Don't forget to set your own conString
...
app.post('/articles', function(request, response) {
  ...
  function queryTwo() {
    client.query(
      ...
      function(err) {
        if (err) console.error(err)
        queryThree() // This is our third query, to be executed when the second is complete. We are also passing the author_id into our third query
      }
    )
  }
